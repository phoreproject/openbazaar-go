...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/phoreproject/btcutil/txsort)
...
```bash
$ go get -u github.com/phoreproject/btcutil/txsort
```
