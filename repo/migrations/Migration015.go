...
func (Migration015) Up(repoPath, dbPassword string, testnet bool) error {
	...
	configMap["DataSharing"] = migration015DataSharing{PushTo: Migration017PushToAfter}
...
func (Migration015) Down(repoPath, dbPassword string, testnet bool) error {
	...
	configMap["DataSharing"] = migration015DataSharing{PushTo: Migration017PushToBefore}
